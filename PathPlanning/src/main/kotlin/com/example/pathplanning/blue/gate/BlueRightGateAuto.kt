package com.example.pathplanning.blue.gate
...
//            .build()
            .followTrajectorySequence {
                it.trajectorySequenceBuilder(startPose)
                    ...
                    .waitSeconds(2.0)
                    .splineTo(Vector2d(-36.0, 20.0), startPose.heading)
                    .splineToSplineHeading(Pose2d(-15.0, 10.0, Math.toRadians(-90.0)), Math.toRadians(0.0))
                    .splineToSplineHeading(Pose2d(30.0, 10.0, Math.toRadians(-90.0)), Math.toRadians(0.0))
