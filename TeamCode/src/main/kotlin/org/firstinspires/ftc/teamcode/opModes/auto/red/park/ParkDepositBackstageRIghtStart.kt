...
@Autonomous(name = "Red Park + 2 Backstage Pixel (Right)", preselectTeleOp = "MainTeleOp")
class ParkDepositBackstageRIghtStart : CommandOpMode() {
    ...
    override fun initialize() {
        ...
        TrajectoryCommand(
            AutoStartPose.RED_LEFT::startPose, driveSubsystem
        ) {
            ...
            .andThen(
                outtakeCommand.withTimeout(1000).alongWith(
                    TrajectoryCommand(
